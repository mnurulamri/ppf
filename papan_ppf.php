...
<head>
	...
	<script src="dhtmlx/dhtmlxScheduler/codebase/ext/dhtmlxscheduler_units.js" type="text/javascript" charset="utf-8"></script>
	<link rel="stylesheet" href="dhtmlx/dhtmlxScheduler/codebase/dhtmlxscheduler.css" type="text/css" title="no title" charset="utf-8">
	...
	<script src="dhtmlx/dhtmlxDataProcessor/codebase/dhtmlxscheduler_recurring.js"></script>
...
<script type="text/javascript" charset="utf-8">
	function init() {
		...
		scheduler.init('scheduler_here',new Date(2017,01,06),"unit");
...
<body onload="init();">
	...
	<div id="scheduler_here" class="dhx_cal_container" style='width:100%; height:100%;'>
		<div class="dhx_cal_navline">
			...
			<div style="top:19px; right:220px; line-height:15px">
				<input type="hidden" id="date_opt" maxlength="5" size="5" onchange="date_opt()"/>
				<img src="../ujian/dhtmlx/dhtmlxScheduler/codebase/imgs_dhx_terrace/calendar.gif" onclick="javascript:NewCssCal('date_opt')" style="cursor:pointer"/>
			</div>				
		</div>
