...
<link rel="shortcut icon" href="../membership/icon.ico" type="image/x-icon" />
<meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
<!-- bootstrap 3.0.2 -->
<link href="<?=base_url();?>assets/theme_admin/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<!-- font Awesome -->
<link href="<?=base_url();?>assets/theme_admin/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
<!-- Ionicons -->
<link href="<?=base_url();?>assets/theme_admin/css/ionicons.min.css" rel="stylesheet" type="text/css" />
<!-- Theme style -->
<link href="<?=base_url();?>assets/theme_admin/css/AdminLTE.css" rel="stylesheet" type="text/css" />

	

<link href="<?=base_url();?>assets/theme_admin/css/jquery-ui-1.8.21.custom.css" rel="stylesheet" type="text/css" />	

<link href="<?=base_url();?>assets/theme_admin/css/custome.css" rel="stylesheet" type="text/css" />	

<!-- jQuery 2.0.2 -->
<script src="<?=base_url();?>assets/theme_admin/js/jquery.min.js"></script>	
<!-- Bootstrap -->
<script src="<?=base_url();?>assets/theme_admin/js/bootstrap.min.js" type="text/javascript"></script>

<script src="<?=base_url();?>assets/theme_admin/js/jqClock.min.js" type="text/javascript"></script>


<!-- AdminLTE App -->
<script src="<?=base_url();?>assets/theme_admin/js/AdminLTE/app.js" type="text/javascript"></script>
...
<div id="data">
<div id="spinner"><div style="background:url(../images/ajaxbig.gif) no-repeat">&nbsp;</div></div>
				...
				<div class="row" style="margin: 0 -15px;">
						...
						<div class="small-box bg-yellow">
							...
							<a class="small-box-footer" href="../membership/lap_kas_pinjaman">
								More info
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="small-box bg-green">
							...
							<a class="small-box-footer" href="../membership/lap_simpanan">
								More info
								<i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="small-box bg-purple">
							...
							<a class="small-box-footer" href="../membership/lap_saldo">
								More info
								<i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="small-box bg-blue">
							...
							<a class="small-box-footer" href="../membership/lap_anggota">
								More info
								<i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
						...
						<div class="small-box bg-red">
							...
							<a class="small-box-footer" href="../membership/pinjaman">
								More info
								<i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<div class="small-box bg-aqua">
							...
							<a class="small-box-footer" href="../membership/user">
								More info
								<i class="fa fa-arrow-circle-right"></i>
							</a>
						</div>
